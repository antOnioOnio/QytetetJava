...
public int menuGestionInmobiliaria(){ //ejemplo de menú
 ...
 public int menuSalirCarcel(){
  ...
  public boolean elegirQuieroComprar(){
      this.mostrar("Quieres comprar propiedad?");
      Map<Integer, String> menuQP = new TreeMap();
      menuQP.put(0, "No");
      menuQP.put(1, "Si");
      int salida = this.seleccionMenu(menuQP);
      this.mostrar("Has elegido " + salida);
